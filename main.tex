...
\newcommand{\stuid}{32x010xxxx}		  		 % 学生学号
\newcommand{\teaname}{李四}		    	  % 指导教师
\newcommand{\stugrade}{202x级}			 		% 学生年级
\newcommand{\stumajor}{物理学} 	 		% 学生专业
\newcommand{\stucollege}{物理学院} 		% 学生所在学院
\newcommand{\stutitle}{毕设中文题目}		% 毕设题目
\newcommand{\stuengtitlelineone}{English Title Line One}			% 毕设英文题目
\newcommand{\stuengtitlelinetwo}{English Title Line Two}			% 毕设英文题目第二行
...
\usepackage{subcaption}  % 导入subcaption宏包
% 设置首行缩进2字符
% 使用 \noindent 命令可以取消缩进
...
\usepackage{fontspec}
\usepackage{amsfonts}
\usepackage{amsmath,amssymb,bm,unicode-math}
\usepackage{upgreek}
\usepackage{pifont}
...
\titleformat{\section}[block]{\zihao{3}\bfseries\centering}{\chinese{section}、}{0pt}{}
...
\begin{document}
    ...
    \end{center}
    \noindent {\zihao{-4} \hspace{0.36em}指导教师对文献综述和开题报告具体要求}
    \tableofcontents
    \noindent {\zihao{-4} \hspace{0.36em}浙江大学本科生文献综述和开题报告考核表}
	\ \\ 
    % 正文
    \newpage
